...
function FeatureSection({ id, eyebrow, title, body, items, graphic, caption, flip, bordered = true }) {
 ...
 <p className="mx-auto mt-4 text-base text-muted-foreground sm:text-lg">{body}</p>
      </FadeInUp>

 <div className="mx-auto mt-12 grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
...
export default function Features() {
 ...
 <h1 className="mx-auto mt-3 text-4xl font-medium tracking-tight text-foreground sm:text-5xl">
              Everything to generate, scan, grade & <span className="text-indigo">analyse</span>
            </h1>
 <p className="mx-auto mt-5 text-base text-muted-foreground sm:text-lg">
              One bank, one roster, a unique shuffled sheet for every student,               scanned, server-side auto-graded, and turned into analytics. Here is
 ...
 <p className="mx-auto mt-4 text-base text-muted-foreground sm:text-lg">
            Folders, organisations and roles let a centre or school collaborate,             while encryption and owner-scoping keep every record isolated and
            auditable.
          </p>
        </FadeInUp>
